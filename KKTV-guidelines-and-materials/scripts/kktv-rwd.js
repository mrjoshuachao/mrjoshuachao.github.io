(function () {
  ...
  function buildMobileNav() {
    ...
    logo.src = "images/kktv-logotype--000000.gif";
    logo.setAttribute("data-hidpi-src", "images/kktv-logotype--000000-2x.gif");
    logo.alt = "KKTV";
    logo.width = 74;
    logo.height = 36;
